...
TeaTalk is early and built in the open. Expect rough edges, expect things to change, and expect the occasional bug — "early and honest" is the point, not "flawless." The current version is always the newest one on the [releases page](https://github.com/vaniteav/teatalk/releases).
